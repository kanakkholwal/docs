---
title: Deploy Nextjs to Cloudflare Workers
description: deploy your Next.js application on Cloudflare Workers using Open Next.
---
...
```json
{
  ...
  /**
     ...
     */
  "vars": {
    "EMAIL_FROM": "no-reply@notifications.nexnauts.com",
    "EMAIL_FROM_NAME": "My Platform",
    "EMAIL_REPLY_TO": "support@nexnauts.com"
  },
  /**
