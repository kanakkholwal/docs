...
description: JavaScript/TypeScript library designed to extract text tables from PDF files efficiently
icon: 'table'
---
[![npm version](https://badge.fury.io/js/pdf-tables-parser.svg)](https://www.npmjs.com/package/pdf-tables-parser)
[![NPM Downloads](https://img.shields.io/npm/dy/pdf-tables-parser)](https://www.npmjs.com/package/pdf-tables-parser)
